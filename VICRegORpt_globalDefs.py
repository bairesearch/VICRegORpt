...
source activate pytorchsenv
	...
	###Trial vicreg code (test based on README.md);
...
if(vicregBiologicalMods):
	...
	if(trainLocal):
		...
		trainLocalConvLocationIndependence = True #local VICReg Conv2D implementation independent of location (move width/height dim to batch dim)
